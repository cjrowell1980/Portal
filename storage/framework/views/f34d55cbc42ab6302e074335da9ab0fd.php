            ...
            <div class="card-body">
                <form action="<?php echo e(route('machines.update', $machine->id)); ?>" method="post">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <input type="hidden" name="customer" id="customer" value="<?php echo e($machine->getCustomer->id); ?>">
                          <input type="text" class="form-control" id="customerName" name="customerName" value="<?php echo e($machine->getCustomer->name); ?>" readonly="">
                        </div>
                    </div>
...
unset($__errorArgs, $__bag); ?>" id="stock" name="stock" value="<?php echo e($machine->stock); ?>">
...
unset($__errorArgs, $__bag); ?>" id="asset" name="asset" value="<?php echo e($machine->asset); ?>">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control text-uppercase <?php $__errorArgs = ['serial'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="serial" name="serial" value="<?php echo e($machine->serial); ?>">
...
unset($__errorArgs, $__bag); ?>" id="make" name="make" value="<?php echo e($machine->make); ?>">
...
unset($__errorArgs, $__bag); ?>" id="model" name="model" value="<?php echo e($machine->model); ?>">
...
unset($__errorArgs, $__bag); ?>" id="yom" name="yom" value="<?php echo e($machine->yom); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\cjrow\OneDrive\Desktop\VSC_Projects\Portal\resources\views/machines/edit.blade.php ENDPATH**/ ?>