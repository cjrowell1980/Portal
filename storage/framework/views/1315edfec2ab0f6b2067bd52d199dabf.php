    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                ...
                <div class="float-end">
                    <a href="<?php echo e(route('roles.edit', $role->id)); ?>" class="btn btn-sm btn-primary"><i class="bi bi-pencil-square"></i> Edit</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\cjrow\OneDrive\Desktop\VSC_Projects\Portal\resources\views/roles/show.blade.php ENDPATH**/ ?>