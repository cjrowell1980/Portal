...
unset($__errorArgs, $__bag); ?>">
                                <option value="1"<?php echo e(($status->parent == "1") ? " selected" : ""); ?>>Jobsheets</option>
                                <option value="2"<?php echo e(($status->parent == "2") ? " selected" : ""); ?>>Photos</option>
                                <option value="3"<?php echo e(($status->parent == "3") ? " selected" : ""); ?>>Incoming Invoices</option>
                                <option value="4"<?php echo e(($status->parent == "4") ? " selected" : ""); ?>>Outgoing Invoices</option>
                            </select>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6 ">
                            <select name="colour" id="colour" class="form-control">
                                <option value="primary"<?php echo e(($status->colour == "primary") ? " selected" : ""); ?>>Primary</option>
                                <option value="secondary"<?php echo e(($status->colour == "secondary") ? " selected" : ""); ?>>Secondary</option>
                                <option value="success"<?php echo e(($status->colour == "success") ? " selected" : ""); ?>>Success</option>
                                <option value="info"<?php echo e(($status->colour == "info") ? " selected" : ""); ?>>Info</option>
                                <option value="warning"<?php echo e(($status->colour == "warning") ? " selected" : ""); ?>>Warning</option>
                                <option value="danger"<?php echo e(($status->colour == "danger") ? " selected" : ""); ?>>Danger</option>
                            </select>
                            <?php if($errors->has('parent')): ?>
                                <span class="text-danger"><?php echo e($errors->first('parent')); ?></span>
                            <?php endif; ?>
